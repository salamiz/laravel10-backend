...
class UnlockAchievementListenerTest extends TestCase
{
    ...
    ** @test */
     ...
     * @dataProvider lessonsWatchedAchievements
     */
    public function user_with_no_lessons_watched_does_not_unlock_achievements($achievementName)
    {
        $user = User::factory()->create();
        $listener = new UnlockAchievementListener();
     ...
     * @dataProvider commentsWrittenAchievements
     */
    public function user_with_no_comments_written_does_not_unlock_achievements($achievementName)
    {
        $user = User::factory()->create();
        $listener = new UnlockAchievementListener();
    ...
    * @dataProvider lessonsWatchedAchievements
    */
    public function it_handles_invalid_user_data_for_lessons_watched($achievementName)
    {
    ...
    * @dataProvider commentsWrittenAchievements
    */
    public function it_handles_invalid_user_data_for_comments_written($achievementName)
    {
        // Expect an exception if the class is designed to throw one on invalid data
        $this->expectException(Exception::class);
        $this->expectExceptionMessage('User not found in the database');
